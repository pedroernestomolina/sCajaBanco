...
namespace DataProvCajaBanco.Infra
{
    public interface IReporteMovimiento
    {
        ...
        OOB.ResultadoLista<OOB.LibCajaBanco.Reporte.Analisis.VentaProducto.Ficha> 
            Reporte_Analisis_VentaProducto(OOB.LibCajaBanco.Reporte.Analisis.VentaProducto.Filtro filtro);
        OOB.ResultadoLista<OOB.LibCajaBanco.Reporte.Analisis.VentaDiaria.Ficha> 
            Reporte_Analisis_VentaDiaria(OOB.LibCajaBanco.Reporte.Analisis.VentaDiaria.Filtro filtro);
        OOB.ResultadoLista<OOB.LibCajaBanco.Reporte.Analisis.VentaPorCierre.Ficha> 
